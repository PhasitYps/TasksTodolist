...
import com.chillchillapp.tasks.todolist.InputTasksActivity
...
class AdapTaskInCalendar(private val activity: Activity, private var taskList: ArrayList<ModelTask>) : RecyclerView.Adapter<AdapTaskInCalendar.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.listview_task_cal, parent, false)
