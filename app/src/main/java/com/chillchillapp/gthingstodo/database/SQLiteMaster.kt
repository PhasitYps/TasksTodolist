...
val COL_TASK_LATITUDE = "Latitude"
val COL_TASK_LONGITUDE = "Longitude"
val COL_TASK_PLACE = "Place"
...
val DATABASE_CREATETask = ("create table IF NOT EXISTS " + TABLE_TASK + "( "
        ...
        + COL_TASK_LATITUDE + " text,"
        + COL_TASK_LONGITUDE + " text,"
        + COL_TASK_PLACE + " text,"
...
val COL_REMINDER_NOTIFYTIME = "NotifyTime"
val COL_REMINDER_STATUS = "Status"
...
val DATABASE_CREATETaskReminder = ("create table IF NOT EXISTS " + TABLE_REMINDER + "( "
        ...
        + COL_TASK_ID + " integer,"
        + COL_REMINDER_NOTIFYTIME + " integer,"
        + COL_REMINDER_STATUS + " text,"
        + COL_UPDATEDATE + " integer,"
        + COL_CREATEDATE + " integer" + ");"
        )
